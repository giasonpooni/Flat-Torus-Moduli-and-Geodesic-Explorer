...
- First-release scope is the area-one flat torus, exact loop lengths, integer windings,
  modular invariance under T and S, and a parallelogram view that consumes those objects.
